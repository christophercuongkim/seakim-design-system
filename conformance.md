...
**Rules version 6.2** — a binding claims conformance *to a version*, because this document
...
seakim_rules: "6.2"     # the rules version you were reviewed against (may lag; never lead)
```
